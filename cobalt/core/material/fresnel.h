#ifndef CBLT_MATERIAL_FRESNEL_H
#define CBLT_MATERIAL_FRESNEL_H
...
inline float FresnelCoef(float cosTheta) {
    const float f = 1.f - cosTheta;
    return f * sqr(sqr(f));
}
