...
#include "rgb2spec/rgb2spec_config.h"
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
#include <assert.h>
...
RGB2Spec *rgb2spec_load(enum rgb2spec_color color) {
    const char *filename = NULL;
    switch (color) {
        case RGB2SPEC_COLOR_ACES2065:
            filename = RGB2SPEC_ACES2065_PATH;
            break;
        case RGB2SPEC_COLOR_PROPHOTO:
            filename = RGB2SPEC_PROPHOTORGB_PATH;
            break;
        case RGB2SPEC_COLOR_REC2020:
            filename = RGB2SPEC_REC2020_PATH;
            break;
        case RGB2SPEC_COLOR_SRGB:
            filename = RGB2SPEC_SRGB_PATH;
            break;
        default:
            return NULL;
    }
